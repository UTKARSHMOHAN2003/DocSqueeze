...
import { CheckIcon } from "lucide-react"; // Using lucide-react instead of Radix icons
              ...
              <button
                ...
                className={cn(
                  ...
                  (period === "Yearly") === isYearly
                    ? "bg-sky-500 text-white shadow-lg" // Sky blue for the active button
                    : "bg-white text-zinc-600 hover:text-zinc-900 dark:bg-zinc-800 dark:text-zinc-400 dark:hover:text-zinc-100" // White for the inactive button
                )}
              >
                {period}
              </button>
          ...
          {tiers.map((tier) => (
            <div
              ...
              className={cn(
                ...
                "flex flex-col",
                tier.highlight
                  ? "bg-gradient-to-b from-black-100/80 to-transparent dark:from-zinc-400/[0.15]"
